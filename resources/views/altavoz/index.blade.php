            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @if (auth()->user()->rol == 'admin')
                        <x-nav-link :href="route('altavoz.create')" :active="request()->routeIs('altavoz.create')"
                            ...
                            <tbody>
                                ...
                                @foreach ($altavoces as $altavoz)
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="px-6 py-4">
                                            @if ($altavoz->alquilado)
                                                <button
                                                    class="font-medium text-purple-600 dark:text-purple-500 cursor-not-allowed"
                                                    disabled>Alquilado</button>
                                            @else
                                                {{--
